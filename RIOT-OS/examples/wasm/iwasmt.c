...
bool iwasm_runtime_init(void)
{
    ...
    init_args.mem_alloc_option.allocator.malloc_func = __wrap_malloc;
    init_args.mem_alloc_option.allocator.realloc_func = __wrap_realloc;
    init_args.mem_alloc_option.allocator.free_func = __wrap_free;
